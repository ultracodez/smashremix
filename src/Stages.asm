...
//      beq         v0, r0, 0x801342F4      // original line 1
    ...
    add_stage(glacial, "Glacial River", -1, {MIDI.id.CLOCKTOWER}, {MIDI.id.SPIDERMAN_THEME}, OS.TRUE, HAZARDS_ON_MOVEMENT_ON, OS.TRUE, OS.TRUE, class.BATTLE, -1, -1, -1, -1, -1, 0x05, 0x05, 0x05, default_blue_shell_rate, default_lightning_rate, default_item_rate, default_item_rate,  MVC, Hazards.type.NONE)
    ...
    add_stage(glacial_remix, "Glacial River Remix", -1, {MIDI.id.CLOCKTOWER}, {MIDI.id.SPIDERMAN_THEME}, OS.TRUE, HAZARDS_ON_MOVEMENT_ON, OS.TRUE, OS.TRUE, class.BATTLE, -1, -1, -1, id.GLACIAL, variant_type.REMIX, 0x05, 0x05, 0x05, default_blue_shell_rate, default_lightning_rate, default_item_rate, default_item_rate,  MVC, Hazards.type.NONE)
