...
scope Spiderman3 {
    ...
    Character.edit_action_parameters(SPM3, Action.ShieldOn,               File.SPM_SHIELDON,              Spiderman.SHIELD_ON,      -1)
    Character.edit_action_parameters(SPM3, Action.ShieldOff,              File.SPM_SHIELDOFF,             Spiderman.SHIELD_OFF,     -1)
    ...
    // UNFINISHED: currently breaks other audio, character disabled until a fix is found (rip public beta)
