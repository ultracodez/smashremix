...
scope ResultsScreen {
    ...
    add_to_results_screen(Character.id.RYU,      FGM.announcer.names.MARIO,              SMASH,           Character.id.CAPTAIN, 185,     RYU,          30,     1,          {MIDI.id.RYU_VICTORY})
    add_to_results_screen(Character.id.KEN,      FGM.announcer.names.LUIGI,              SMASH,           Character.id.CAPTAIN, 185,     KEN,          30,     1,          {MIDI.id.RYU_VICTORY})
