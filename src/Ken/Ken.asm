...
scope Ken {
    ...
    Character.edit_action_parameters(KEN,   Action.ThrowB,          File.RYU_THROWB,            THROWB,                     0x50000000)
    ...
    Character.edit_action_parameters(KEN,   Action.FSmash,          File.RYU_FSMASH,            FSMASH,                     0x40000000)
    Character.edit_action_parameters(KEN,   Action.FSmashLow,       File.RYU_FSMASH,            FSMASH,                 0x40000000)
